...
Suppose we plan to use this research compendium to write a manuscript on summarizing rivers. First we will make an R script to put in `analysis`. Recall that in [Exercise 1.2.7.1.2](#ex-set3), we generated `river_stats()`, whose body looks like
```{r}
