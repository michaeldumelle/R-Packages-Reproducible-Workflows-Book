...
Welcome to the 2021 EPA R Workshop titled ``Using R Packages for Reproducible Workflows'' by me, Michael Dumelle -- I am glad to have you here! Before proceeding, let's download \href{https://devtools.r-lib.org/}{devtools} and then the presentation's companion R package
...
\item
  \protect\hyperlink{r-packages}{Building an R Package}
\item
